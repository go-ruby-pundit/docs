...
Contributions are welcome. `go-ruby-pundit/pundit` is built to a small set of
...
The library is in [`github.com/go-ruby-pundit/pundit`](https://github.com/go-ruby-pundit/pundit).
This documentation site is in [`github.com/go-ruby-pundit/docs`](https://github.com/go-ruby-pundit/docs).
