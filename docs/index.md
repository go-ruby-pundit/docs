# go-ruby-pundit documentation

**Pure-Go, MRI-4.0.5-faithful Ruby pundit (no cgo)**

`go-ruby-pundit/pundit` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `pundit`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `pundit`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`pundit`](https://github.com/go-ruby-pundit/pundit) | the library — Ruby's `pundit` in pure Go |
| [`docs`](https://github.com/go-ruby-pundit/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-pundit.github.io`](https://github.com/go-ruby-pundit/go-ruby-pundit.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-pundit/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-pundit/pundit](https://github.com/go-ruby-pundit/pundit).
