...
The public API lives at the module root (`github.com/go-ruby-pundit/pundit`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `pundit`, while the surface follows
...
```go
import "github.com/go-ruby-pundit/pundit"
```
...
- **[pkg.go.dev/github.com/go-ruby-pundit/pundit](https://pkg.go.dev/github.com/go-ruby-pundit/pundit)**

The module's [README](https://github.com/go-ruby-pundit/pundit#readme) carries worked
